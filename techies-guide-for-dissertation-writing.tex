...
the question like ``Hey, what is your research question?'' In short, that is one
way the Ph.D. people communicate with each other --- even without any common
backgrounds or prior knowledge on the research topics.

It is the same with your dissertation. Your research question needs to be
narrowed down as a Ph.D.-level research question. And your research question
shows what kind of direction you are heading into. It conveys the
``direction'' information to other researchers.

And remember that your research question can be changing as time goes on. The
big theme will remain the same, you will have several sub-questions from the
big theme question. As your research goes on, you will update your research
questions based on your findings and learnings. 
...
% Not sure why I put this paragraph. An additional explanation of using slides
% for your draft writing but..?
